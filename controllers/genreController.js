...
exports.genre_detail = function(req, res, next) {
    ...
    async.parallel({
        ...
        genre_books: function (callback) {
            ...
            if (err) {return 'somethings wrong'}
...
exports.genre_update_get = function(req, res, next) {
    //Update genre by id
    Genre.findById(req.params.id, function (err, adventure) {
        if (err) {return next(err)}
        res.render('genre_form', {title: 'Upgrade Genre', genre: adventure})
