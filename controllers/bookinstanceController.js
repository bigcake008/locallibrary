...
exports.bookinstance_update_get = function(req, res, next) {
    BookInstance.findById(req.params.id)
        ...
        .exec(function (err, result) {
            if (err) {return next(err)}
            res.render('bookinstance_form', {'bookinstance': result})
        });
};
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            BookInstance.findById(req.params.id)
                ...
                .exec(function (err, result) {
                    if (err) {return next(err)}
                    res.render('bookinstance_form', {title: 'Update instance', bookinstance: result, errors: errors.array() })
                })
